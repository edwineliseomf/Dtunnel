...
export class ConfigName extends TextFiled {
    ...
    validate() {
        if (!this.getValue()) {
            throw new Error('Establecer un nombre para la configuración')
        }
    }
}
...
export class ConfigSni extends TextFiled {
    ...
    validate() {
        if (!this.getValue()) {
            throw new Error('Establecer una SNI para la configuración')
        }
    }
}
...
export class ConfigOpenVPN extends TextAreaFiled {
    ...
    validate() {
        if (!this.getValue()) {
            throw new Error('Establezca el certificado OpenVPN en configuración')
        }
    }
}
...
export class ConfigV2ray extends TextAreaFiled {
    ...
    validate() {
        if (!this.getValue()) {
            throw new Error('Configuración V2Ray invalida!')
        }
    }
}
...
export class ConfigProxy extends TextFiled {
    ...
    validate() {
        if (!this.getValue()) {
            throw new Error('Establecer un PROXY para la configuración')
        }
    }
}
...
export class ConfigServer extends TextFiled {
    ...
    validate() {
        if (!this.getValue()) {
            throw new Error('Establecer un SERVIDOR para la configuración')
        }
    }
}
...
export class ConfigPort extends NumberFiled {
    ...
    validate() {
        if (!this.getValue()) {
            throw new Error('Establecer un puerto para la configuración')
        }
    }
}
...
export class ConfigUrlCheckUser extends TextFiled {
    constructor(url) {
        ...
        this._btnCheckUrl.innerHTML = 'Testear'
    ...
    async _checkUrlOKClick() {
        try {
            ...
            if (isUrlOK) showToastSuccess('Tu URL está bien!')
