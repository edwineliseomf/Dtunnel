                ...
                <div class="d-flex flex-column gap-2 justify-content-center">
                    <div class="card">
                        <div class="card-body p-2">
                            ...
                            <p class="card-text">Esta versión contiene solo modos de conexión SSH, OpenVPN y V2RAY</p>
                            <a href="https://apps.diegopintoteam.com/Vpn.apk" class="btn btn-dark w-100 mt-2">DESCARGAR</a>
                        </div>
                    </div>
                </div>
            </div>
